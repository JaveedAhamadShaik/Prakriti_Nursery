...
const Pots = () => {
  ...
  const categories = ["All", "Ceramic", "Plastic", "Fiber", "Terracotta", "Metal", "Rotomold", "Hanging"];
      ...
      <section className="bg-gradient-to-r from-terracotta/10 to-sand/10 py-8 sm:py-12 md:py-16">
        <div className="container px-4 sm:px-6">
          <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            ...
            <span className="text-primary font-medium text-sm sm:text-base">Pots & Planters</span>
          </div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-3 sm:mb-4">Pots & Planters</h1>
